...
* The original package name 'com.experia.device-matching-backend-service' is invalid and this project uses 'com.experia.device_matching_backend_service' instead.
